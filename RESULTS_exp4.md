...
- Phase-boundary classification mismatches away from floating-point equality:
  **$0/19{,}125$**.
- Maximum scaled stationarity residual: **$1.18\times10^{-15}$**.
- Maximum difference between the new batched solver and 40 independently
  selected calls to the original scalar solver: **$8.32\times10^{-13}$**.

Figure 1a shows the canonical $r_1/r_2=4$, $\varepsilon=10^{-3}$ slice. The
numerical zero-to-positive transition follows
$\alpha_c=\log(4)/\log(G)$ over the entire plot. At $\alpha=1$, equality occurs
at $G=4$, so $G\leq4$ is collapsed and the minority first becomes positive at
$G=5$.
...
the minority at $\alpha=1$. Conversely, when $\varepsilon<1/G$, changing
$\varepsilon$ has no effect because every nonzero empirical frequency is
already at least $1/G$.

Figure 1c combines all four axes. Every extinct point lies at $m\leq0$; positive
...
$(\log\alpha,\log\rho,\log\varepsilon)$ at $G=16$. Direct root solves at
...
|---:|---:|---:|---:|---:|
| $5$ | $2.767\times10^{-2}$ | $2.223\times10^{-2}$ | $4.032\times10^{-2}$ | $1.699\times10^{-1}$ |
| $9$ | $1.229\times10^{-2}$ | $9.905\times10^{-3}$ | $1.786\times10^{-2}$ | $6.952\times10^{-2}$ |
| $17$ | **$5.215\times10^{-3}$** | **$2.485\times10^{-3}$** | **$9.683\times10^{-3}$** | $6.337\times10^{-2}$ |
...
used to make precise survival decisions near $m=0$ or $\varepsilon=1/G$. Direct
